...
export default function Ecommerce() {
  ...
  const currentUrl = typeof window !== 'undefined' ? window.location.href : `${siteUrl}/en/cases/ecommerce`
  const ogImage = `${siteUrl}/logo.png`
  const title = String(t('pages.cases.ecommerce.title'))
  const description = String(t('pages.cases.ecommerce.description'))
  ...
  return (
    <>
      <Head>
        ...
        <link rel="alternate" hrefLang="en" href={`${siteUrl}/en/cases/ecommerce`} />
        <link rel="alternate" hrefLang="ru" href={`${siteUrl}/cases/ecommerce`} />
        <link rel="alternate" hrefLang="es" href={`${siteUrl}/es/cases/ecommerce`} />
