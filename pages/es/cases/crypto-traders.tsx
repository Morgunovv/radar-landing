...
export default function CryptoTraders() {
  ...
  const currentUrl = typeof window !== 'undefined' ? window.location.href : `${siteUrl}/es/cases/crypto-traders`
  const ogImage = `${siteUrl}/logo.png`
  const title = String(t('pages.cases.crypto.title'))
  const description = String(t('pages.cases.crypto.description'))
