...
export default function MediaJournalists() {
  ...
  const currentUrl = typeof window !== 'undefined' ? window.location.href : `${siteUrl}/es/cases/media-journalists`
  ...
  return (
    <>
      <Head>
        ...
        <link rel="alternate" hrefLang="en" href={`${siteUrl}/en/cases/media-journalists`} />
        <link rel="alternate" hrefLang="ru" href={`${siteUrl}/cases/media-journalists`} />
        <link rel="alternate" hrefLang="es" href={`${siteUrl}/es/cases/media-journalists`} />
