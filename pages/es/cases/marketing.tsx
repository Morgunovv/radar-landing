...
export default function Marketing() {
  ...
  const currentUrl = typeof window !== 'undefined' ? window.location.href : `${siteUrl}/es/cases/marketing`
  ...
  return (
    <>
      <Head>
        ...
        <link rel="alternate" hrefLang="en" href={`${siteUrl}/en/cases/marketing`} />
        <link rel="alternate" hrefLang="ru" href={`${siteUrl}/cases/marketing`} />
        <link rel="alternate" hrefLang="es" href={`${siteUrl}/es/cases/marketing`} />
